...
0. **Ordem de Fabricação + cores** — desenho FECHADO em
   [`ORDEM_FABRICACAO.md`](ORDEM_FABRICACAO.md). Fases A–C feitas. A exigência de
   OF só vale depois que o DONO clicar "Ligar exigência de OF" na aba. Falta a
   D (relatórios de tempo por OF).
